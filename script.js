...
const splitTypes = document.querySelector('#information1')
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  button.addEventListener("click", () => {
    button.style.backgroundColor = "#FF5733"; // Change to your desired color on click
  });
});
...
// write this also bitians are, were and will be second to none
// using relative units like vw and vh you can make your website responsive at the same time.